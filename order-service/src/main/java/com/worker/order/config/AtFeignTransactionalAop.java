//package com.worker.order.config;
//
//
...
//
//    @Before("execution(* com.worker.order.controller.*.*(..))")
...
//    }
//
//    @AfterThrowing(throwing = "e", pointcut = "execution(* com.worker.order.controller.*.*(..))")
...
//    }
//
//    @AfterReturning(value = "execution(* com.worker.order.controller.*.*(..))", returning = "result")
