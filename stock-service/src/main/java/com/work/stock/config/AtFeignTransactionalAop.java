...
//
//    @Before("execution(* com.work.stock.controller.*.*(..))")
...
//    }
//
//    @AfterThrowing(throwing = "e", pointcut = "execution(* com.work.stock.controller.*.*(..))")
...
//    }
//
//    @AfterReturning(value = "execution(* com.work.stock.controller.*.*(..))", returning = "result")
